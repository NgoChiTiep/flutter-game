...
class EnemyManager extends Component with HasGameRef<MyGame> {
  ...
  void spawnRandomEnemy() {
    ...
    if (enemyData.canFly) {
      final newHeight = _random.nextDouble() * 3 * enemyData.textureSize.y;
  ...
  void onMount() async {
    shouldRemove = false;
    final enemy1 = await gameRef.images.load('Walk (36x30).png');
    final enemy2 = await gameRef.images.load('Flying (46x30).png');
    final enemy3 = await gameRef.images.load('Run (52x34).png');
